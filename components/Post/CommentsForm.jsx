      ...
      <div className='bg supports-backdrop-blur:bg-white/95 dark:bg-zinc-900/75 border border-sky-900 rounded-lg p-8 pb-12 mb-8'>
        ...
        <div className='mt-8'>
          <button
            ...
            className='bg-blue-400 inline-block rounded-full font-bold px-8 py-3 transition-all hover:bg-blue-700'
          >
            Comment
          </button>
          {showSuccessMessage && (
            <span className='float-right font-semibold mt-3 text-green-500'>Thank you</span>
          )}
        </div>
      </div>
    )
